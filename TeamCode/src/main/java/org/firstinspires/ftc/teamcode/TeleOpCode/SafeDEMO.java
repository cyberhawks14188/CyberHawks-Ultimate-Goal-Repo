...
@TeleOp
public class SafeDEMO extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && forceStop) {//Main loop that our TeleOp loops in
            ...
            if(gamepad2.right_trigger > .08){
                DrivetrainClass.DriveBase(gamepad2.left_stick_x, gamepad2.left_stick_y, gamepad2.right_stick_x, false);
                RingClass.RingSystemControlDEMO(gamepad2.dpad_down, gamepad2.dpad_up, gamepad2.dpad_right, gamepad2.dpad_left, gamepad2.a, gamepad2.b, Ring1Color.red, Ring2Color.red, Ring3Color.red, gamepad2.back, ShooterClass.sotAngleSetReturn(),gamepad2.right_bumper);
                ...
                RingClass.RingSystemControlDEMO(gamepad1.dpad_down, gamepad1.dpad_up, gamepad1.dpad_right, gamepad1.dpad_left, gamepad1.a, gamepad1.b, Ring1Color.red, Ring2Color.red, Ring3Color.red, gamepad1.back, ShooterClass.sotAngleSetReturn(), gamepad2.right_bumper);
