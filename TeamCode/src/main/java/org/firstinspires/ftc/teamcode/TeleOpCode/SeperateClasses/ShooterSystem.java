...
public class ShooterSystem {
    ...
    public void shooterControl(boolean leftbumper, double shootermotorcurrent, double runtime, double sotanglecurrent, double intakepower, double rightstick){
        ...
        SOTAngleSet = SOTAngleSet + (rightstick * .001);
